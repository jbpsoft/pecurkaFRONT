...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form method="post" action="{{ AdminOptions::base_url() }}admin-update-product/{{ $data->id }}">
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" name="cena_proizvoda" class="form-control input-sm" Placeholder="{{ $data->cena_proizvoda }}" autocomplete="off">
          </div>
        </div>
      </div>
